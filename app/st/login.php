    ...
    <div class="authentication-inner py-4 m-3">
      ...
      <div class="card p-2">
        ...
        <div class="card-body mt-2">
          <h4 class="mb-2 fw-semibold">Continue your Adventure 🚀</h4>
          <p class="mb-4">Welcome back, login to continue.</p>
          ...
          <form id="loginform" class="mb-3" action="index.html" method="POST">
            ...
            <button type="button" onclick='login()' class="btn btn-primary d-grid w-100">
              Login
            </button>
          </form>
...
<script src="../../assets/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script>
  ...
  <script>
    function login(){
      ...
      $.get('phpajax/login', form, function(data){
        console.log(data)
        if (data == 'failed1') {
            notie.alert({ type: 'error', position: 'bottom', text: 'Invalid Login', time: 5 });
         }
        if (data == 'success') {
